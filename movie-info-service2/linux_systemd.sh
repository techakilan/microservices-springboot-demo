     ...
     CUSTOM_SERVICE_NAME=movie-info-service2
     JAR_FILE_PATH=$PROJECT_PATH/movie-info-service2/target/movie-info-service.jar
     PID_NAME_PATH=/tmp/movie-info-service2-pid
     case $1 in
     start)
